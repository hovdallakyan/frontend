...
export function EmptyState({ message, hint, variant = 'default' }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center rounded-2xl border border-dashed border-slate-200 bg-white/60 px-6 py-16 text-center">
      ...
      {hint && <p className="mt-1 text-sm font-medium text-slate-400">{hint}</p>}
    </div>
  );
}
